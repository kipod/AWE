...
SIZE_T MmUseCounts[MMPFNUSE_SIZE];
SIZE_T MmPageUseCounts[MMPFNUSE_SIZE][TransitionPage + 1];
...
void PrintHeader() {
	printf("MemInfo - Show PFN database information\n");
	printf("https://github.com/kipod/AWE\n\n");
}
